...
player_loan<-read.csv("C:\\Users\\krishna\\Desktop\\PROJECT_UPD\\Final_project\\data\\201920loandata.csv")
...
over_loan <- read_csv("C:\\Users\\krishna\\Desktop\\PROJECT_UPD\\Final_project\\data\\201920loandata.csv") %>% tidy_transfers()
...
shinyServer<- function(input, output, session) {
  ...
  rawdata <- eventReactive(input$use, {
    if (input$source == "example") {
      read_csv("C:\\Users\\krishna\\Desktop\\PROJECT-2020\\FactorAnalysis-master\\data\\sample_rank.csv")
